...
*For the application to work correctly you must first install [OpenCV](https://sourceforge.net/projects/opencvlibrary/files/4.3.0/opencv-4.3.0vc14_vc15.exe/download) on your computer*
